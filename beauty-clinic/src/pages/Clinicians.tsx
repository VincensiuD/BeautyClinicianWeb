...
export const Clinicians = () => {
  ...
  async function fetchData() {
    const data = await customFetch("http://localhost:3000/api/clinicians");
    if (data) {
      setClinicians(data);
      console.info(data);
    }
    ...
    <div className="clinicians-main-div">
      ...
      <div className="clinician-opening-div">
        <p>
          ...
          personal touch. With diverse backgrounds, years of experience, and
          just the right amount of personality, we believe great results start
          with great people.
        </p>
      </div>
